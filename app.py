...
if menu == "Entenda os dados":
    ...
    with col3:
        st.markdown("<h2>Candidatos que <span style='color:#E07A5F;'>saíram do seu \n último emprego há mais tempo</span>, têm \n <span style='color:#E07A5F;'><b>menor chance</b></span> de trocar de emprego</h2>")
        ...
        st.markdown("<h3>Os candidatos <span style='color:#E07A5F;'>graduados</span> buscam \n por novos empregos com <span style='color:#E07A5F;'><b>mais frequência</b></span></h3>")
        ...
        st.markdown("<h3>Quanto <span style='color:#E07A5F;'>maior o IDH</span> da \n cidade em que se localiza a empresa, \n <span style='color:#E07A5F;'><b>menos candidatos</b></span> buscam por novos empregos</h3>")
    ...
    with col4:
        ...
        st.markdown("<h3>E candidatos que <span style='color:#E07A5F;'>estudaram \n em tempo integral</span>, procuram por um emprego <span style='color:#E07A5F;'><b>com mais frequência</b></span></h3>", unsafe_allow_html=True)

        st.markdown("<h3>E o <span style='color:#E07A5F;'>tipo e tamanho</span> \n da empresa, em <span style='color:#E07A5F;'><b>pouco influencia</b></span> \n a quantidade de candidatos a procura de emprego</h3>", unsafe_allow_html=True)
