...
if menu == "Entenda os dados":
    ...
    st.markdown("<h3>Os dados utilizados são referentes à intenção de profissionais da área de dados em trocar de emprego. Para que seja determinada a probabilidade do profissional estar interessado em mudar de emprego, foram analisados dados de gênero, formação e experiência profissional, assim como dados das vagas que ocupavam no momento da coleta dos dados.</h3>", unsafe_allow_html=True)

    st.markdown("<h3>A partir disso, foi possível determinar um modelo de classificação binária, que mostrou desempenho de XXX em acurácia para o conjunto geral dos dados. Também não foi identificado overfitting no modelo escolhido. Para saber mais sobre a escolha do modelo e seu desempenho, acesse a página XXX</h3>", unsafe_allow_html=True)

    col1, col2 = st.columns([1, 1])

    with col1:
        st.markdown("<h3>Cerca de <span style='color:#E07A5F;'>25%</span> dos candidatos <span style='color:#E07A5F;'><b>estão em busca de um novo emprego</b></span></h3>", unsafe_allow_html=True)

    with col2:
        st.markdown("<h3>As intenções dos candidatos <span style='color:#E07A5F;'><b>não</b></span> são afetadas pelo seu <span style='color:#E07A5F;'>gênero</span>, <span style='color:#E07A5F;'>área de formação</span> e <span style='color:#E07A5F;'>horas de treinamento</span></h3>", unsafe_allow_html=True)


    col3, col4 = st.columns([1.5, 1])

    with col3:
        st.markdown("<h2>Candidatos que <span style='color:#E07A5F;'>saíram do seu <br> último emprego há mais tempo</span>, têm <br> <span style='color:#E07A5F;'><b>menor chance</b></span> de trocar de emprego</h2>", unsafe_allow_html=True)
        ...
        st.markdown("<h3>Os candidatos <span style='color:#E07A5F;'>graduados</span> buscam <br> por novos empregos com <span style='color:#E07A5F;'><b>mais frequência</b></span></h3>", unsafe_allow_html=True)
        ...
        st.markdown("<h3>Quanto <span style='color:#E07A5F;'>maior o IDH</span> da <br> cidade em que se localiza a empresa, <br> <span style='color:#E07A5F;'><b>menos candidatos</b></span> buscam por novos empregos</h3>", unsafe_allow_html=True)
    ...
    with col4:
        st.markdown("<h3>E candidatos <span style='color:#E07A5F;'>sem experiência prévia</span> relevante, procuram por um emprego <span style='color:#E07A5F;'><b>com mais frequência</b></span></h3>", unsafe_allow_html=True)

        st.markdown("<h3>E candidatos que <span style='color:#E07A5F;'>estudaram <br> em tempo integral</span>, procuram por um emprego <span style='color:#E07A5F;'><b>com mais frequência</b></span></h3>", unsafe_allow_html=True)

        st.markdown("<h3>E o <span style='color:#E07A5F;'>tipo e tamanho</span> <br> da empresa, em <span style='color:#E07A5F;'><b>pouco influencia</b></span> <br> a quantidade de candidatos a procura de emprego</h3>", unsafe_allow_html=True)
