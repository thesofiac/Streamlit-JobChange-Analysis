...
if menu == "Entenda os dados":
    ...
    st.markdown("Candidatos que <span style='color:#E07A5F;'>saíram do seu último emprego há mais tempo</span>, têm <span style='color:#E07A5F;'><b>menor chance</b></span> de trocar de emprego")
    ...
    # Adicionar os valores acima de cada ponto
    for i in range(len(df1)):
        ax.annotate(f"{df1['y'][i]:.0f}",  # valor com 1 casa decimal + símbolo de %
...
#    # Bloco 3: IDH
#    st.markdown("<h3>Quanto maior o IDH da cidade, menos candidatos buscam novos empregos</h3>", unsafe_allow_html=True)
