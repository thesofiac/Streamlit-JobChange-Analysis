...
if menu == "Entenda os dados":
    ...
    with col1:
        ...
        plt.plot(df1['x'], df1['y'], linestyle='-', marker='o', color='#f15050ff')
        plt.xlabel('Anos desde o último emprego')
        plt.ylabel('Porcentagem de candidatos \n em busca de empregos')
        plt.grid(False)
        plt.tight_layout()
        plt.gca().set_yticks([])
        plt.show()
...
#    with col2:
#        st.markdown("<h3>Candidatos graduados buscam mais por empregos</h3>", unsafe_allow_html=True)
